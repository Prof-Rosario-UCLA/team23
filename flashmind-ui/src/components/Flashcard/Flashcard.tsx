...
export default function Flashcard({ front, back, flipped, onFlip }: FlashcardProps) {
  return (
    ...
    >
      <p className="min-h-[6rem] text-2xl font-semibold text-gray-800">
        {flipped ? back : front}
      </p>
      <div className="pointer-events-none absolute bottom-0 left-0 h-12 w-full bg-red-600 text-center text-sm tracking-wide text-white">
